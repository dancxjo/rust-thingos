...
impl RustGenerator {
    pub fn generate(&self, schema: &ir::Schema) -> String {
        ...
        out.push_str("// This file is the canonical source of Kind-derived types.\n");
        out.push_str("// To regenerate: run `just kindc-gen` from the repository root.\n");
        out.push_str("// Manual edits will be overwritten and may cause CI drift failures.\n");
