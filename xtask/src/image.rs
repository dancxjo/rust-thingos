...
pub fn default_programs() -> Vec<ProgramConfig> {
    let mut programs = vec![
        ...
        ProgramConfig { name: "acpid", is_init: false, boot_module: true, features: vec![] },
        ProgramConfig { name: "acpi_ec", is_init: false, boot_module: true, features: vec![] },
        ProgramConfig { name: "acpi_power", is_init: false, boot_module: true, features: vec![] },
        ProgramConfig { name: "acpi_battery", is_init: false, boot_module: true, features: vec![] },
        ProgramConfig { name: "acpi_thermal", is_init: false, boot_module: true, features: vec![] },
        ProgramConfig {
            name: "acpi_backlight",
            is_init: false,
            boot_module: true,
        ...
        ProgramConfig { name: "acpi_i2c_hid", is_init: false, boot_module: true, features: vec![] },
        ProgramConfig {
            name: "acpi_gpio_keys",
            is_init: false,
            boot_module: true,
        ...
        ProgramConfig {
            name: "acpi_irq_routing",
            is_init: false,
            boot_module: true,
            features: vec![],
        },
        ProgramConfig { name: "acpi_sleep", is_init: false, boot_module: true, features: vec![] },
        ProgramConfig {
            name: "acpi_vendor_hotkeys",
            is_init: false,
            boot_module: true,
            features: vec![],
        },
...
fn is_bootstrap_boot_module(name: &str) -> bool {
    is_driver(name)
        ...
        || matches!(name, "sprout" | "hello" | "clock" | "calc" | "leaf" | "themes")
}
