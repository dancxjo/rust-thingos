...
pub use channel::{
    ...
    channel_send, channel_send_all, channel_try_recv, ChannelHandle, ChannelThing,
};
pub use vfs::{
    dup, dup2, pipe, tcgetattr, tcsetattr, vfs_chdir, vfs_chmod, vfs_close, vfs_fchmod, vfs_fcntl,
    vfs_handle_from_channel, vfs_thing_from_channel, vfs_fsync, vfs_futimes, vfs_getcwd,
    vfs_isatty, vfs_mkdir, vfs_mount, vfs_open, vfs_poll, vfs_read, vfs_readdir, vfs_readv,
    vfs_realpath, vfs_rename, vfs_seek, vfs_stat, vfs_umount, vfs_unlink, vfs_utimes, vfs_watch_fd,
