...
/// System events
pub const KIND_ID_THINGOS_EVENT: [u8; 16] = [
    0x9f, 0x7c, 0x85, 0xee, 0x06, 0xfd, 0xb9, 0xa3, 0xa3, 0x87, 0x43, 0x36, 0x76, 0xd0, 0xa8, 0xa9,
];

#[derive(Clone, Debug, PartialEq, Eq)]
pub enum Event {
    InterruptRequested { source: String },
    JobExited { job: ThingId, code: i32 },
    Message { kind: ThingId, payload: Vec<u8> },
}

/// A representation of a Schema with an encoding
pub const KIND_ID_THINGOS_FORM: [u8; 16] = [
    0xd0, 0x4f, 0x69, 0xe9, 0x08, 0xa0, 0x82, 0x04, 0x44, 0xe3, 0xd1, 0x51, 0x3e, 0x2c, 0xb1, 0xb9,
];
...
pub const KIND_ID_THINGOS_FS_NODE: [u8; 16] = [
    0xac, 0xf2, 0xa0, 0x85, 0x91, 0xd7, 0x11, 0x63, 0x6c, 0x95, 0x3c, 0x6a, 0xf2, 0x4d, 0x19, 0xd4,
];
...
pub const KIND_ID_THINGOS_FS_NODE_KIND: [u8; 16] = [
    0x22, 0x10, 0x0a, 0x7c, 0x86, 0xe9, 0xca, 0xcb, 0xe9, 0x55, 0xca, 0x5b, 0xa2, 0x61, 0xdc, 0xb9,
];
...
pub const KIND_ID_THINGOS_GROUP: [u8; 16] = [
    0xc4, 0x0f, 0x62, 0x93, 0x69, 0x19, 0x33, 0x0b, 0x2e, 0xba, 0x45, 0x9b, 0xbc, 0xf3, 0xaf, 0x6e,
];
...
pub const KIND_ID_THINGOS_GROUP_KIND: [u8; 16] = [
    0xd0, 0xcc, 0xcd, 0x49, 0x5b, 0x15, 0xa0, 0x92, 0x65, 0x3a, 0x08, 0xbb, 0x52, 0xc0, 0x0f, 0x81,
];
...
pub const KIND_ID_THINGOS_GROUP_ID: [u8; 16] = [
    0xad, 0x12, 0xbb, 0x29, 0x90, 0x49, 0x35, 0x69, 0x69, 0xc6, 0xde, 0x5c, 0x19, 0x89, 0x0d, 0x88,
];
...
pub const KIND_ID_THINGOS_JOB: [u8; 16] = [
    0x64, 0x54, 0xcb, 0x77, 0x25, 0xb9, 0xf6, 0x04, 0x88, 0x46, 0xff, 0x01, 0x3d, 0x5d, 0x66, 0x78,
];
...
pub const KIND_ID_THINGOS_JOB_ID: [u8; 16] = [
    0x9b, 0xac, 0xf6, 0x12, 0xb0, 0xae, 0xde, 0xc1, 0x80, 0xde, 0x45, 0x57, 0x4b, 0xe4, 0xa1, 0xa8,
];

pub type JobId = u64;

/// Metadata about a Kind itself
pub const KIND_ID_THINGOS_KIND: [u8; 16] = [
    0xbf, 0xaa, 0x45, 0xe3, 0x51, 0xbe, 0x90, 0xb4, 0x22, 0x7c, 0x11, 0x3a, 0x91, 0x7b, 0x11, 0x7b,
];
...
pub const KIND_ID_THINGOS_MESSAGE: [u8; 16] = [
    0x71, 0x69, 0xe9, 0x49, 0xac, 0x1f, 0x62, 0xc5, 0xee, 0x79, 0xd7, 0xcf, 0x26, 0xa6, 0x4c, 0xeb,
];
...
pub const KIND_ID_THINGOS_PERSON: [u8; 16] = [
    0x63, 0x04, 0xcf, 0x17, 0xeb, 0xb9, 0xc2, 0x41, 0x68, 0x0f, 0xd4, 0x6f, 0x35, 0x9d, 0x4f, 0x22,
];
...
pub const KIND_ID_THINGOS_PERSON_KIND: [u8; 16] = [
    0x7a, 0xad, 0x6e, 0xc4, 0x67, 0xa6, 0xcf, 0x7b, 0xfc, 0xc6, 0x95, 0xe2, 0x5b, 0xe3, 0x2f, 0x79,
];
...
pub const KIND_ID_THINGOS_PLACE_KIND: [u8; 16] = [
    0xb1, 0x43, 0xd7, 0x35, 0x77, 0x01, 0x69, 0x89, 0x2c, 0xf0, 0xd1, 0x4e, 0xbe, 0x67, 0x51, 0x8b,
];
...
pub const KIND_ID_THINGOS_SIGNAL: [u8; 16] = [
    0x95, 0x34, 0x43, 0xd5, 0xfb, 0x78, 0xdf, 0xee, 0xe2, 0x6b, 0xdf, 0x35, 0x8d, 0xc9, 0xbf, 0xe3,
];
...
pub const KIND_ID_THINGOS_SIGNAL_FAULT: [u8; 16] = [
    0x12, 0x74, 0xd1, 0xcc, 0x56, 0x95, 0x75, 0x90, 0x21, 0x9c, 0x17, 0xdd, 0x75, 0x65, 0xa3, 0x1d,
];
...
pub const KIND_ID_THINGOS_SPACE: [u8; 16] = [
    0x5d, 0x71, 0xd3, 0x24, 0xbd, 0x89, 0x73, 0x48, 0x67, 0xbf, 0x7c, 0x96, 0x78, 0x7a, 0x1b, 0xe4,
];
...
pub const KIND_ID_THINGOS_SPACE_ID: [u8; 16] = [
    0x88, 0xb7, 0x9f, 0x5c, 0x87, 0x06, 0x77, 0xfd, 0xbd, 0xd5, 0x7b, 0x39, 0x99, 0x6d, 0x5b, 0x0c,
];

pub type SpaceId = u64;

/// Arguments for the task_create syscall
pub const KIND_ID_THINGOS_SYS_TASK_CREATE_ARGS: [u8; 16] = [
    0xb8, 0x24, 0xa5, 0x89, 0xee, 0x48, 0x93, 0xc5, 0xb8, 0xe1, 0x81, 0x4e, 0x36, 0x69, 0x69, 0xc2,
];
...
pub const KIND_ID_THINGOS_SYS_TASK_CREATE_RESULT: [u8; 16] = [
    0x1d, 0xbb, 0x26, 0x49, 0xbb, 0x43, 0xdc, 0x97, 0x8d, 0xcb, 0xd3, 0x78, 0x6f, 0xce, 0x54, 0xd1,
];
...
pub const KIND_ID_THINGOS_TASK: [u8; 16] = [
    0x14, 0xfb, 0x7f, 0x65, 0x97, 0x8c, 0x4f, 0xd7, 0x8c, 0xf2, 0x1f, 0x2c, 0x43, 0xc2, 0xe9, 0xc3,
];
...
pub const KIND_ID_THINGOS_TASK_STATE: [u8; 16] = [
    0x7c, 0x53, 0x41, 0x3f, 0xed, 0x32, 0x05, 0x53, 0xdb, 0x63, 0x96, 0x34, 0x28, 0x65, 0x01, 0xc8,
];
...
pub const KIND_ID_THINGOS_TASK_ID: [u8; 16] = [
    0x7d, 0x39, 0x42, 0xd1, 0xbb, 0x65, 0x07, 0x31, 0x39, 0x90, 0x88, 0xd2, 0xab, 0x27, 0xeb, 0xe0,
];
...
pub const KIND_ID_THINGOS_THING: [u8; 16] = [
    0x23, 0xc5, 0x8e, 0x51, 0xfd, 0xc2, 0xe2, 0xbf, 0xf3, 0x9c, 0xc4, 0xc4, 0x3f, 0x39, 0x81, 0x1b,
];
...
/// Driver-ready notification — sent by Cambium (or a spawned driver) to the
...
/// V1 payload for `KIND_ID_THINGOS_DRIVER_READY`.
///
/// Wire layout is `#[repr(C)]`; all integer fields are native-endian (little-
/// endian on all supported ThingOS targets).
///
/// - `version`  — always `1` for this layout.
/// - `flags`    — reserved; must be `0`.
/// - `pid`      — PID of the spawned driver process.
/// - `task_id`  — stable task identifier (same as `pid` for v1; reserved for
///               future cross-restart correlation).
/// - `status`   — `0` = initialisation succeeded; negative = error code.
/// - `reserved` — must be `0`.
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct DriverReadyV1 {
    pub version: u16,
    pub flags: u16,
    pub pid: u32,
    pub task_id: u64,
...
impl DriverReadyV1 {
    /// Construct a success notification for the given driver `pid`.
    pub fn new_ok(pid: u32) -> Self {
        Self { version: 1, flags: 0, pid, task_id: pid as u64, status: 0, reserved: 0 }
    }

    /// Interpret a raw byte slice as a `DriverReadyV1`.
    ///
    ...
    pub fn from_bytes(bytes: &[u8]) -> Option<Self> {
        ...
        // SAFETY: `bytes` is at least `size_of::<DriverReadyV1>()` long and
        // `DriverReadyV1` is a plain `#[repr(C)]` struct of integer types with
    ...
    /// Borrow `self` as a byte slice suitable for `msg_send`.
