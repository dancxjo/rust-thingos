...
s! {
    ...
    pub struct posix_spawnattr_t {
        ...
        __sd: crate::sigset_t,
        __ss: crate::sigset_t,
        #[cfg(any(target_env = "musl", target_env = "ohos", target_os = "thingos"))]
        __prio: c_int,
        #[cfg(not(any(target_env = "musl", target_env = "ohos", target_os = "thingos")))]
    ...
    #[cfg_attr(
        all(
            any(target_env = "musl", target_env = "ohos", target_os = "thingos"),
            target_pointer_width = "32"
        ),
        repr(align(4))
    )]
    ...
    #[cfg_attr(
        all(
            not(any(target_env = "musl", target_env = "ohos", target_os = "thingos")),
            target_arch = "x86"
        ),
        repr(align(4))
    )]
...
cfg_if! {
    if #[cfg(not(any(target_env = "musl", target_env = "ohos", target_os = "thingos")))] {
        extern "C" {
...
cfg_if! {
    if #[cfg(target_env = "uclibc")] {
        mod uclibc;
        pub use self::uclibc::*;
    } else if #[cfg(any(target_env = "musl", target_env = "ohos", target_os = "thingos"))] {
        mod musl;
        pub use self::musl::*;
