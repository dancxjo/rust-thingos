...
|---|------|--------|----------|-----------|
| 1 | Given the machine is booted | ✅ | 24664ms | - - - |
| 2 | When I wait for the shell prompt | ✅ | 1192ms | - [📜](./02/serial.log) - |
| 3 | And I type "ping -c 1 iana.org" on the serial console | ✅ | 1616ms | - [📜](./03/serial.log) - |
| 4 | And I wait for the serial output to contain "1 packets transmitted, 1 received" | ❌ | 6076ms | - [📜](./04/serial.log) - |
