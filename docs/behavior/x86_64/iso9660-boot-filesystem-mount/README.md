...
|----------|-------|--------|------|
| iso9660d mounts the boot filesystem at /media/cdrom | 1/2 | ❌ | [View Details](iso9660d-mounts-the-boot-filesystem-at-media-cdrom/README.md) |
...
| boot ISO files are accessible at /media/cdrom via QEMU -cdrom | 4/5 | ❌ | [View Details](boot-iso-files-are-accessible-at-media-cdrom-via-qemu-cdrom/README.md) |
