...
|---|------|--------|----------|-----------|
| 1 | Given the machine is booted | ✅ | 19279ms | - - - |
| 2 | When I wait for the shell prompt | ✅ | 562ms | - [📜](./02/serial.log) - |
| 3 | And I type "echo /share/wallpapers/flower.bmp > /session/desktop/wallpaper" on the serial console | ✅ | 1091ms | - [📜](./03/serial.log) - |
| 4 | And I type "echo /share/wallpapers/flower.bmp > /session/desktop/wallpaper" on the serial console | ✅ | 1076ms | - [📜](./04/serial.log) - |
| 5 | Then the log should match pattern "bloom: service loop started" | ❌ | 1013ms | - [📜](./05/serial.log) - |
