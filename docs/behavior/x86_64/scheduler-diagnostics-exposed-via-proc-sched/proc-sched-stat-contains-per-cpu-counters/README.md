...
|---|------|--------|----------|-----------|
| 1 | Given the machine is started | ✅ | 15ms | - - - |
| 2 | When I wait for the system to boot | ✅ | 24148ms | - [📜](./02/serial.log) - |
| 3 | And the shell command "cat /proc/sched/stat" succeeds | ✅ | 399ms | - [📜](./03/serial.log) - |
| 4 | Then the output contains "context_switches:" | ❌ | 1030ms | - [📜](./04/serial.log) - |
