...
|---|------|--------|----------|-----------|
| 1 | Given the machine is booted | ✅ | 11062ms | - [📜](./01/serial.log) - |
| 2 | When I wait for the shell prompt | ✅ | 2103ms | - [📜](./02/serial.log) - |
| 3 | And I type "ls /bin" on the serial console | ✅ | 1412ms | - [📜](./03/serial.log) - |
| 4 | And I wait for 2 seconds | ✅ | 2000ms | - - - |
| 5 | And I type "ipc_provider_demo &" on the serial console | ✅ | 2026ms | - [📜](./05/serial.log) - |
| 6 | And I wait for 2 seconds | ✅ | 2000ms | - - - |
| 7 | And I type "attr_list /run/cookbook/hello.txt" on the serial console | ✅ | 2751ms | - [📜](./07/serial.log) - |
| 8 | Then the serial output should contain "provider.name" | ✅ | 1ms | - - - |
| 9 | And the serial output should contain "provider.is_demo" | ✅ | 1ms | - - - |
| 10 | And the serial output should contain "provider.requests" | ✅ | 0ms | - - - |
| 11 | When I type "attr_set /run/cookbook/hello.txt user.comment utf8 'This_is_a_test'" on the serial console | ✅ | 4496ms | - [📜](./11/serial.log) - |
| 12 | And I wait for 1 seconds | ✅ | 1000ms | - - - |
| 13 | And I type "attr_get /run/cookbook/hello.txt user.comment" on the serial console | ✅ | 3370ms | - [📜](./13/serial.log) - |
| 14 | Then the serial output should contain "type=Utf8 len=14" | ❌ | 301067ms | - - - |
...
[32095788747] [[32mINFO [0m] [kernel] [CPU0] Initializing global allocator...
...
[35080358115] [[32mINFO [0m] [kernel] [CPU0] Initializing SIMD...
[35084958810] [[32mINFO [0m] [kernel] [CPU0] Initializing tasking...
[35166987009] [[32mINFO [0m] [kernel::sched] [CPU0] Scheduler initialized
[35954470365] [[32mINFO [0m] [kernel] [CPU0] Entering scheduler loop.
[36101489127] [[32mINFO [0m] [sprout] [CPU0] SPROUT: v0.4.1 [REBUILT] starting (Supervisor Mode)...
[1;32m
        .-.
       /   \        [1;36mTHING-OS[1;32m
...
[2m--------------------------------------------------------------[0m
[1;95mTHING[0m[1;96m-OS[0m [2;94m[[0m[1;95mBOOT[0m[2;94m][0m [1;93m/[0m [1;96m>[0m [?25h[38604094089] [[32mINFO [0m] [netd] [CPU2] NETD: Starting network service...
[38741610732] [[32mINFO [0m] [netd] [CPU2] NETD: Waiting for virtio_netd VFS provider at /dev/net/virtio*...
[39000684723] [[32mINFO [0m] [iso9660d] [CPU1] iso9660d: no ISO9660 filesystem found yet — retrying
ls /bin
...
[57688688310] [[32mINFO [0m] [ipc_provider_demo] [CPU3] ipc_provider_demo: starting up
[57698245407] [[32mINFO [0m] [ipc_provider_demo] [CPU3] ipc_provider_demo: port pair write_h=1 read_h=2
[57710134020] [[32mINFO [0m] [ipc_provider_demo] [CPU3] ipc_provider_demo: mounted at /run/cookbook
[2] 15
[1;95mTHING[0m[1;96m-OS[0m [2;94m[[0m[1;92mOK[0m[2;94m][0m [1;93m/[0m [1;96m>[0m [?25h[58055830899] [[32mINFO [0m] [netd] [CPU2] NETD: Network ready
attr_list /run/cookbook/hello.txt
[?25l[73414700172] [[32mINFO [0m] [ipc_provider_demo] [CPU3] ipc_provider_demo: request #1 op=Lookup
SYS_FS_ATTR_LIST: fd=6 buf_ptr=7fdfa8 buf_len=8192
[73438099350] [[32mINFO [0m] [ipc_provider_demo] [CPU3] ipc_provider_demo: request #2 op=AttrList
...
[?25l[88234389639] [[32mINFO [0m] [ipc_provider_demo] [CPU3] ipc_provider_demo: request #3 op=Lookup
[88265084193] [[32mINFO [0m] [ipc_provider_demo] [CPU3] ipc_provider_demo: request #4 op=AttrSet
[88269761943] [[32mINFO [0m] [ipc_provider_demo] [CPU3] ipc_provider_demo: set attr 'user.comment' type=Utf8 len=16
attr_set: wrote 0
...
[?25l[102641736120] [[32mINFO [0m] [ipc_provider_demo] [CPU3] ipc_provider_demo: request #5 op=Lookup
[102674254452] [[32mINFO [0m] [ipc_provider_demo] [CPU3] ipc_provider_demo: request #6 op=AttrGet
type=Utf8 l
```
</details>
