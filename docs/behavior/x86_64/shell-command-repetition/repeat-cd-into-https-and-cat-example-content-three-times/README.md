...
|---|------|--------|----------|-----------|
| 1 | Given the machine is booted | ✅ | 16896ms | - - - |
| 2 | When I wait for the shell prompt | ✅ | 2305ms | - [📜](./02/serial.log) - |
| 3 | And I type "cd /https" on the serial console | ✅ | 1519ms | - [📜](./03/serial.log) - |
| 4 | And I type "cat www.example.com" on the serial console | ✅ | 2042ms | - [📜](./04/serial.log) - |
| 5 | And I type "cd /https" on the serial console | ✅ | 1520ms | - [📜](./05/serial.log) - |
| 6 | And I type "cat www.example.com" on the serial console | ✅ | 2043ms | - [📜](./06/serial.log) - |
| 7 | And I type "cd /https" on the serial console | ✅ | 1518ms | - [📜](./07/serial.log) - |
| 8 | And I type "cat www.example.com" on the serial console | ✅ | 2036ms | - [📜](./08/serial.log) - |
...
[50424737418] [[32mINFO [0m] [kernel] [CPU0] Initializing global allocator...
...
[54120494505] [[32mINFO [0m] [kernel] [CPU0] Initializing SIMD...
[54125538192] [[32mINFO [0m] [kernel] [CPU0] Initializing tasking...
[kernel:task:init] begin
[kernel:task:init] registry init ok
[54238950282] [[32mINFO [0m] [kernel::sched] [CPU0] Scheduler initialized
...
[bran:runtime] framebuffer begin
[bran:runtime] framebuffer ok
[55298556753] [[32mINFO [0m] [kernel] [CPU0] Entering scheduler loop.
[55561193259] [[32mINFO [0m] [sprout] [CPU0] SPROUT: v0.4.1 [REBUILT] starting (Supervisor Mode)...
[bran:runtime] modules begin
[bran:req] get_modules enter
[bran:req] get_modules cache hit
[bran:runtime] modules ok
...
[?25l[73935556728] [[32mINFO [0m] [httpsd] [CPU3] httpsd: upstream open failed for handle=2 https://www.example.com: http connect failed: http connect socket: timed out waiting for readiness
...
[?25l[85727591235] [[32mINFO [0m] [httpsd] [CPU1] httpsd: upstream open failed for handle=3 https://www.example.com: http connect failed: http connect socket: timed out waiting for readiness
cat: error reading www.example.com
[?25h[1;95mTHING[0m[1;96m-OS[0m [2;94m[[0m[1;92mOK[0m[2;94m][0m [1;93m/https[0m [1;96m>[0m [?25hcd /https
[1;95mTHING[0m[1;96m-OS[0m [2;94m[[0m[1;92mOK[0m[2;94m][0m [1;93m/https[0m [1;96m>[0m [?25hcat www.example.com
```
