...
|---|------|--------|----------|-----------|
| 1 | Given the machine is booted | ✅ | 16521ms | - [📜](./01/serial.log) - |
| 2 | When I wait for the shell prompt | ✅ | 2207ms | - [📜](./02/serial.log) - |
| 3 | And I type "ps" on the serial console | ✅ | 1163ms | - [📜](./03/serial.log) - |
...
[48930118875] [[32mINFO [0m] [kernel] [CPU0] Initializing global allocator...
...
[52700649936] [[32mINFO [0m] [kernel] [CPU0] Initializing SIMD...
[52710603924] [[32mINFO [0m] [kernel] [CPU0] Initializing tasking...
[kernel:task:init] begin
[kernel:task:init] registry init ok
[52851170691] [[32mINFO [0m] [kernel::sched] [CPU0] Scheduler initialized
...
[bran:runtime] framebuffer begin
[bran:runtime] framebuffer ok
[54017655021] [[32mINFO [0m] [kernel] [CPU0] Entering scheduler loop.
[54191593599] [[32mINFO [0m] [sprout] [CPU0] SPROUT: v0.4.1 [REBUILT] starting (Supervisor Mode)...
[bran:runtime] modules begin
[bran:req] get_modules enter
[bran:req] get_modules cache hit
[bran:runtime] modules ok
