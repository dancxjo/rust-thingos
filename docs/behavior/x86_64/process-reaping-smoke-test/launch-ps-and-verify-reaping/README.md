...
> Last run: 2026-04-20 18:51:28

## Steps

| # | Step | Result | Duration | Artifacts |
|---|------|--------|----------|-----------|
| 1 | Given the machine is booted | ✅ | 15972ms | - [📜](./01/serial.log) - |
| 2 | When I wait for the shell prompt | ✅ | 2209ms | - [📜](./02/serial.log) - |
| 3 | And I type "ps" on the serial console | ✅ | 1166ms | - [📜](./03/serial.log) - |
...
[47359359729] [[32mINFO [0m] [kernel] [CPU0] Initializing global allocator...
...
[51001910949] [[32mINFO [0m] [kernel] [CPU0] Initializing SIMD...
[51007960146] [[32mINFO [0m] [kernel] [CPU0] Initializing tasking...
[51119794407] [[32mINFO [0m] [kernel::sched] [CPU0] Scheduler initialized
[52053332331] [[32mINFO [0m] [kernel] [CPU0] Entering scheduler loop.
[52192688658] [[32mINFO [0m] [sprout] [CPU0] SPROUT: v0.4.1 [REBUILT] starting (Supervisor Mode)...
[1;32m
        .-.
       /   \        [1;36mTHING-OS[1;32m
